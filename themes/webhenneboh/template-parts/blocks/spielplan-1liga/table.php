  ...
  <thead>
		...
		<tr>
			...
			<th title="Spielpaarung"class="spielpaarung"><p>Spielpaarung</p></th>
			  <th title="ergebnis" class="ergebnis"><p>Ergebnis</p></th>
			<th title="hz" class="hz"><p>(HZ)</p></th>
	  ...
	  <?php
		while ( have_rows( 'row' ) ) :
		  ...
		  <td class="ergebnis">
			  ...
			  <p class="res-tbody"><?php the_sub_field( 'ergebnis' ); ?></p>
		  </td>
		  <td class="hz">

			  <p class="res-tbody">(<?php the_sub_field( 'hz' ); ?>)</p>
		  </td>
